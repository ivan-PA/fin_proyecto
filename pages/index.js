...
import ordenador from "../public/images/ordenador.png";
    ...
    <>
      <div>
        ...
        <div className="bg-gradient-to-b from-blue-500  to-white grid grid-row-2 lg:grid-cols-2 items-center max-h-min">
          <div className="pl-10">
            <p className="text-6xl text-black font-bold mt-10">
              Por fin has llegado
        ...
        <div className="bg-white">
          <div className="pl-10 py-10">
            <p className="text-5xl text-gray-600  font-serif font-bold text-center">
        ...
        <div className="bg-white items-center flex justify-center py-10">
          <div className="pl-10">
